...
const FormEditBooking = ({ id }) => {
     ...
     const { data, loading, error } = useQuery(LOAD_BOOKING, {
          variables: {
               _eq: id,
          },
     });
     ...
     const validationSchema = Yup.object({
          ...
          last_name: Yup.string().matches(
               regexCharacter,
               "nama belakang tidak boleh mengandung simbol"
          ),
          email: Yup.string()
          ...
          package_id: Yup.string().required("pilihan paket tidak boleh kosong"),
          date: Yup.string().required("tanggal tidak boleh kosong"),
          time: Yup.string().required("waktu mulai tidak boleh kosong"),
